...
AWS_RANGES_CSV_FILE="ip-ranges.csv"
...
## All AWS ranges as a csv
jq -r '.prefixes[].ip_prefix' "$AWS_DIRECTORY/$AWS_RANGES_FILE" | sort -V > "$AWS_DIRECTORY/$AWS_RANGES_CSV_FILE"
